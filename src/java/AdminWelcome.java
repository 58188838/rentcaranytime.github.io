...
public class AdminWelcome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1 style='color:white; font-size:15px; margin-left:600px;'>welcome"+" "+username+"</h1>");
            //out.println("<a href='index.html' style='margin-top=50;'><h4 style='float: right; color: red;'>Logout</h4></a>");
